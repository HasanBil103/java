...
public class dogumgunuu {
	...
	public static void main(String[] args) {
		...
		int gun = 0, sayi = 0, ay = 0, y1 = 1, y2 = 0, y3 = 0, y4 = 0;
		...
		if (sayi8 == 1) {
			if (sayi7 == 1 && sayi6 == 1 & sayi5 == 1) {
				ay += 5;
				System.out.println("\nYanlış kodladınız ama ben ayı yinede 12 basacağım!!!");
			} else if (sayi7 == 1 && sayi6 == 1) {
				ay += 6;
				System.out.println("\nYanlış kodladınız ama ben ayı yinede 12 basacağım!!!");
			} else if (sayi7 == 1 && sayi5 == 1) {
				ay += 7;
				System.out.println("\nYanlış kodladınız ama ben ayı yinede 12 basacağım!!!");
			} else {
				ay += 8;
		...
		if (sayi12 == 1) {
			if (sayi11 == 1 && sayi10 == 1 && sayi9 == 1) {
				y2 += 2;
				System.out.println("\nYanlış kodladınız ama ben 2. basamağı yinede  9 olarak basacağım!!!");
			} else if (sayi11 == 1 && sayi10 == 1) {
				y2 += 3;
				System.out.println("\nYanlış kodladınız ama ben 2. basamağı yinede  9 olarak basacağım!!!");

			} else if (sayi11 == 1 && sayi9 == 1) {
				y2 += 4;
				System.out.println("\nYanlış kodladınız ama ben 2. basamağı yinede  9 olarak basacağım!!!");
			} else {
				y2 += 8;
		...
		if (sayi13 == 0) {
			...
			if (sayi17 == 1) {
				if (sayi16 == 1 && sayi15 == 1 && sayi14 == 1) {
					y3 += 2;
					System.out.println("\nYanlış kodladınız ama ben 3. basamağı yinede  9 olarak basacağım!!!");
				} else if (sayi16 == 1 && sayi15 == 1) {
					y3 += 3;
					System.out.println("\nYanlış kodladınız ama ben 3. basamağı yinede  9 olarak basacağım!!!");
				} else if (sayi16 == 1 && sayi14 == 1) {
					y3 += 4;
					System.out.println("\nYanlış kodladınız ama ben 3. basamağı yinede  9 olarak basacağım!!!");
				} else {
					y3 += 8;
		...
		if (sayi18 == 0) {
			...
			if (sayi22 == 1) {
				...
				if (sayi21 == 1 && sayi20 == 1 && sayi19 == 1) {
					y4 += 2;
					System.out.println("\nYanlış kodladınız ama ben 4. basamağı yinede  9 olarak basacağım!!!");
				} else if (sayi21 == 1 && sayi20 == 1) {
					y4 += 3;
					System.out.println("\nYanlış kodladınız ama ben 4. basamağı yinede  9 olarak basacağım!!!");
				} else if (sayi21 == 1 && sayi19 == 1) {
					y4 += 4;
					System.out.println("\nYanlış kodladınız ama ben 4. basamağı yinede  9 olarak basacağım!!!");
				} else {
					y4 += 8;
		...
		System.out.println("Doğum gününüz : " + gun + "." + ay + "." + y1 + y2 + y3 + y4);

		if (((gun >= 22 || gun <= 31) && ay == 1) || (gun <= 19 && ay == 2)) {
			System.out.println("Kova burcusunuz: ");
			System.out
					.println("Hayal güçleri sınırsız olmakla birlikte, düşünceleri bulundukları anın ötesinde, akılcı "
		...
		if (((gun >= 20 || gun <= 31) && ay == 2) || (gun <= 20 && ay == 3)) {
		...
		if (((gun >= 21 || gun <= 31) && ay == 3) || (gun <= 20 && ay == 4)) {
		...
		if (((gun >= 21 || gun <= 31) && ay == 4) || (gun <= 21 && ay == 5)) {
		...
		if (((gun >= 22 || gun <= 31) && ay == 5) || (gun <= 22 && ay == 6)) {
		...
		if (((gun >= 23 || gun <= 31) && ay == 6) || (gun <= 22 && ay == 7)) {
			System.out.println("Yengeç burcusunuz : ");
			System.out.println(
					"Yaşamlarındaki her konuda aşırı bir şekilde hassas, alıngan ve kuruntulu olan Yengeç'leri "
		...
		if (((gun >= 23 || gun <= 31) && ay == 7) || (gun <= 22 && ay == 8)) {
		...
		if (((gun >= 23 || gun <= 31) && ay == 8) || (gun <= 22 && ay == 9)) {
		...
		if (((gun >= 23 || gun <= 31) && ay == 9) || (gun <= 22 && ay == 10)) {
		...
		if (((gun >= 23 || gun <= 31) && ay == 10) || (gun <= 21 && ay == 11)) {
		...
		if (((gun >= 22 || gun <= 31) && ay == 11) || (gun <= 21 && ay == 12)) {
			System.out.println("Yay burcusunuz : ");
			System.out
					.println("Kavrama yetenekleri gelişmiş olduğundan becerikliliklerinin de katkısı ile ele aldıkları "
